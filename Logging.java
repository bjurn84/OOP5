...
public class Logging {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            LOGGER.warning("Не удалось создать файл лога");
        }
        ...
        while (true) {
            ...
            LOGGER.info("Получение данных для вычислений");
            ...
            switch (choice) {
                case 1:
                    ...
                    LOGGER.info("Выполнено сложение рациональных чисел");
                    System.out.println("Результат: " + rnResult);
                    break;
                case 2:
                    rnResult = rn1.subtract(rn2);
                    LOGGER.info("Выполнено вычитание рациональных чисел");
                    System.out.println("Результат: " + rnResult);
                    break;
                case 3:
                    rnResult = rn1.multiply(rn2);
                    LOGGER.info("Выполнено умножение рациональных чисел");
                    System.out.println("Результат: " + rnResult);
                    break;
                case 4:
                    rnResult = rn1.divide(rn2);
                    LOGGER.info("Выполнено деление рациональных чисел");
                    System.out.println("Результат: " + rnResult);
                    break;
                default:
            ...
            switch (choice) {
                case 1:
                    ...
                    LOGGER.info("Выполнено сложение комплексных чисел");
                    System.out.println("Результат: " + cnResult);
                    break;
                case 2:
                    cnResult = cn1.subtract(cn2);
                    LOGGER.info("Выполнено вычитание комплексных чисел");
                    System.out.println("Результат: " + cnResult);
                    break;
                case 3:
                    cnResult = cn1.multiply(cn2);
                    LOGGER.info("Выполнено умножение комплексных чисел");
                    System.out.println("Результат: " + cnResult);
                    break;
                case 4:
                    cnResult = cn1.divide(cn2);
                    LOGGER.info("Выполнено деление комплексных чисел");
                    System.out.println("Результат: " + cnResult);
                    break;
                default:
                    LOGGER.warning("Неверный выбор");
